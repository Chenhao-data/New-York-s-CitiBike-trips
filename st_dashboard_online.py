...
csv_path = os.path.join(folderpath, 'Data')
sample_df=pd.read_csv(os.path.join(csv_path, 'reduced_data_to_plot_7.csv'))
top_20=pd.read_csv(os.path.join(csv_path, 'top_20.csv'))
sample_aggregated=pd.read_csv(os.path.join(csv_path, 'sample_aggregated.csv'))
hourly_rides=pd.read_csv(os.path.join(csv_path, 'hourly_rides.csv'))
############################################ DEFINE THE PAGES #####################################################################
...
### MAP PAGE: INTERACTIVE MAP WITH AGGREGATED BIKE TRIPS
    ...
    path_to_html = "NewYork Bike Trips TOP20 Aggregated.html" 
